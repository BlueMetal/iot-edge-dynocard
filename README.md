...
For more information on how to use the Solution and different Components involved in the solution, please refer **[Wiki](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/dynocards-wiki/Home.md)** URL
