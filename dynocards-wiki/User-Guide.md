...
![alt text](https://github.com/nvtuluva/iot-edge-dynocard/blob/master/images/oil%26gas-userguide.png)
...
![alt text](https://github.com/nvtuluva/iot-edge-dynocard/blob/master/images/71.png)

2. Now It will direct to **overview** page of the **dynocardVM**. 

3. **Copy** the **public IP address**.

![alt text](https://github.com/nvtuluva/iot-edge-dynocard/blob/master/images/72.png)

4. Open **Remote Desktop Connection** on your local computer and **paste** the copied **dynocardVM** Public IP address.

![alt text](https://github.com/nvtuluva/iot-edge-dynocard/blob/master/images/73.png)
...
![alt text](https://github.com/nvtuluva/iot-edge-dynocard/blob/master/images/74.png)

7. Now Click **Yes** button to continue.

![alt text](https://github.com/nvtuluva/iot-edge-dynocard/blob/master/images/75.png)
...
![alt text](https://github.com/nvtuluva/iot-edge-dynocard/blob/master/images/76.png)
...
![alt text](https://github.com/nvtuluva/iot-edge-dynocard/blob/master/images/77.png)

10. Click **Turn Windows Firewall on or off**, which is located in the left side Menu bar.

![alt text](https://github.com/nvtuluva/iot-edge-dynocard/blob/master/images/78.png)

11. When you click  **Turn Windows Firewall on or off**, you will be directed to below page.

![alt text](https://github.com/nvtuluva/iot-edge-dynocard/blob/master/images/79.png)

12. Now select **Turn off windows firewall** radio button for both public and private network settings then click **ok**.

![alt text](https://github.com/nvtuluva/iot-edge-dynocard/blob/master/images/80.png)

13. Now you can see, the Windows Firewalls of dynocardVM are stopped.

![alt text](https://github.com/nvtuluva/iot-edge-dynocard/blob/master/images/81.png)

14. Run the 2nd version of **ModRSsim2** simulator by double clicking it.

![alt text](https://github.com/nvtuluva/iot-edge-dynocard/blob/master/images/82.png)

![alt text](https://github.com/nvtuluva/iot-edge-dynocard/blob/master/images/83.png)

15. Click on **Animation setting** icon, which is in the right-side menu bar.

![alt text](https://github.com/nvtuluva/iot-edge-dynocard/blob/master/images/84.png)

16. Select the **"Training PLC Simulation"** option and browse the **DynoCard.vbs** script in downloaded section of the VM.

![alt text](https://github.com/nvtuluva/iot-edge-dynocard/blob/master/images/85.png)

![alt text](https://github.com/nvtuluva/iot-edge-dynocard/blob/master/images/86.png)

![alt text](https://github.com/nvtuluva/iot-edge-dynocard/blob/master/images/87.png)

17. Select **Analog Inputs 300000**.

![alt text](https://github.com/nvtuluva/iot-edge-dynocard/blob/master/images/88.png)

![alt text](https://github.com/nvtuluva/iot-edge-dynocard/blob/master/images/89.png)
...
![alt text](https://github.com/nvtuluva/iot-edge-dynocard/blob/master/images/90.png)
...
![alt text](https://github.com/nvtuluva/iot-edge-dynocard/blob/master/images/91.png)
...
![alt text](https://github.com/nvtuluva/iot-edge-dynocard/blob/master/images/oil-a2.png)
...
![alt text](https://github.com/nvtuluva/iot-edge-dynocard/blob/master/images/108.png)
...
![alt text](https://github.com/nvtuluva/iot-edge-dynocard/blob/master/images/oil-a4.png)

Copy the **server** name and **database** name

![alt text](https://github.com/nvtuluva/iot-edge-dynocard/blob/master/images/oil-a5.png)
