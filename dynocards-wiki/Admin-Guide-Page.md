...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/oil%26gas-adminguide.png)
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/39.png)

2.After clicking on stream analytics job, you will be directed to below screen.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/40.png)
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/41.png)

4.Click on **Renew authorization** button and click **save**.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/42.png)

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/43.png)
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/44.png)

6.Now you can see the Stream analytics job is **Running**.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/45.png)
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/100.png)

2.Go to overview section and scroll down to check the IoT Hub messages.

Here you can confirm the data is coming to IoT Hub.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/101.png)
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/Iothub1.png)
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/Iothub2.PNG)

3.Go to IoT Hub endpoints And verify that the endpoint status is healthy. 

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/Iothub3.PNG)
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/sqlsku1.PNG)

2. Navigate to configure blade. 

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/sqlsku2.PNG)
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/sqlsku3.PNG)

## 6. Verify run history of Logic App

1.Go to **Resource group** -> click on **logicapp26hs3** logic app.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/128.png)

2.Go to overview page of Logic app to see the Runs history. You can see status as Succeeded.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/129.png)

3.Click on any one of the Succeeded run.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/130.png)

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/131.png)

4.Click on duration of the run **41s**

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/132.png)

5.Click on show raw inputs to view the Uri, method and body.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/133.png)

## 7.  Verify data in Data Lake Store

1.Go to **Resource Group** -> click on **datalakestore26hs3** data lake store.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/134.png)

2.Navigate to **Data  explorer** blade.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/135.png)

3.Click on **dynocards**  folder to see the data.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/136.png)

4.Click on the JSON file to open it.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/137.png)
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/138.png)

2. Go to overview page of service bus to see the successful requests, Incoming and outgoing messages graph.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/139.png)

### 8.1 Update SKU for Service Bus Name Space [Administrative Task] 

1. Go to Resource Group -> click on service bus namespace 

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/sbussku1.PNG)

2. Navigate to scale blade. 

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/sbussku2.PNG)
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/sbussku3.PNG)
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/140.png)

2.Now you can check input events and output events graph under overview section

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/141.png)
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/apisku1.PNG) 

3. In free tier app service plan **auto scale** is not available. 

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/apisku2.PNG) 
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/apisku3.PNG)

2. After updating app service plan from free to standard.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/apisku4.PNG)

3. In **Overview page** you can see the updated app service plan tier **Standard: 1 small.**

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/apisku5.PNG)
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/apisku6.PNG)
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/apisku7.PNG)
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/apisku8.PNG)
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/apisku9.PNG)
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/apisku10.PNG)
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/apisku11.PNG)
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/212.png)

2. On **Overview** page, Summary details are displayed as shown in the following figure.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/213.png)
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/214.png)    

3. Here you can see the **Live Requests** of the Web App as shown in the following figure.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/215.png)
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/216.png)

5. The Application Insights page is displayed and **click Home Page** tab.  

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/217.png)
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/218.png)
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/219.png)

8. Similarly, you can run the other common Pre-defined queries by navigating back to the **Home Page**.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/220.png)
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/221.png)

11. **Click Edit** as shown in the following figure.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/222.png)

12. You can select any of the **listed Metrics** to view application logs.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/223.png)
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/224.png)

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/225.png)

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/226.png)
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/227.png)

2. Click **Azure Resources** on left side menu to view available Azure Resources.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/228.png)

3. Select your **Resource Group** name from the dropdown list.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/229.png)

4. Access **OMS portal** from OMS Workspace from the left side menu. Click on **OMS Workspace** -> **OMS Portal**.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/230.png)
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/231.png)

6. Click **Azure SQL Analytics** to view the SQL Server logs.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/232.png)

7. Click **sqldb** under DATABASE column, as shown in the following figure to view the detailed information.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/233.png)

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/234.png)

8. Click **Home icon** on the left side of the page for **Web Apps Analytics**.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/235.png)

9. Click **Logic App Management (Preview)** to view each web application logs as highlighted in the following figure.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/236.png)

10. Click **Succeeded** in the Logic App Management (Preview).

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/237.png)

11. The **Succeeded logs** are displayed as shown in the following figure.              

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/238.png)

12. **Click Failed** in the Logic App Management (Preview) page as highlighted in the following figure.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/239.png)

13. The **Failed logs are displayed** as shown in the following figure.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/240.png)

14. **Click Running** in the Logic App Management (Preview) page as highlighted in the following figure.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/241.png)

15. **The Running logs are displayed** as shown in the following figure.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/242.png)

16. **Click All Status** in the Logic App Management (Preview) page as highlighted in the following figure.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/243.png)

17. The **All Status logs** are displayed as shown in the following figure.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/244.png)
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/245.png)
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/246.png)
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/247.png)
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/248.png)
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/249.png)
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/250.png)

2.Select **Geo-Replication** under the **SETTINGS** section.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/251.png)
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/252.png)
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/sqlgeo1.png)

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/253.png)

6.Click on **Failover**. 

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/254.png)
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/255.png)
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/256.png)
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/257.png) 
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/258.png) 
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/259.png) 
 
2. Click on **ON** to **Enable Firewall** and make sure to select **Allow access to Azure services** to **ON**. click on **Save**. 

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/260.png) 

3. Once firewall configuration completed successfully, a popup will be opened as below.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/261.png) 
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/262.png) 
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/263.png) 

2. Click on **Shared access policies** and below shared access policies will be displayed.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/264.png) 
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/265.png)
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/266.png) 

2. Click on **+Add**
3. Provide below required parameters and click on **Create**. 
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/267.png) 
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/268.png) 
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/269.png) 
 
1. Click on **shared access policies**.
 
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/270.png) 

2. Clicking on **RootmanageSharedAccessKey** provides connection string that can used to authenticate service bus name space.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/271.png) 
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/272.png) 

2. Click on **Set Server Firewall**. 

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/273.png) 

3. Click on **+Add Client IP** and click on **Save**. 

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/274.png) 
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/275.png) 

2. Navigate **Active directory admin** blade.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/276.png) 

3. Click on **set admin**.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/277.png) 

4. Choose user and click on **Select**.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/278.png) 

5. Click on **Save**.
Now Database is accessible from active directory credentials.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/279.png) 


6. Now Database is accessible with AD Credentials.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/280.png) 
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/281.png) 

2. Click on **Advanced Threat Protection** under **Security** in left side menu.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/282.png) 
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/283.png) 

4. SQL Supports below detection types.
 
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/284.png) 
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/285.png) 
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/286.png) 

2. To use own key, click on **Yes**. Choose from key vault or enter key identifier manually. And click on **Save**.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/287.png) 
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/288.png) 

2. Login to the **Dynocard** VM with the credentials provided at ARM template deployment. Close running simulator.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/289.png) 


### 15.1.2. IoTHub Manual Failover
1. Go to **Resource Group** ->  Click on **IoTHub**.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/290.png) 

2. Go to **Manual Failover (Preview)** from left side menu.
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/291.png) 

3. Click on **Initiate failover** to initiate manual failover of IoTHub.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/292.png) 
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/293.png) 

2. Click on **Failover groups** on left hand menu.
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/294.png) 

3. Click on **Failover Group**. 
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/295.png) 

A page will be displayed as below. Click on **Failover** and click on **Yes** for confirmation.
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/296.png) 
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/297.png) 

2. Stop the Stream analytics job by click on **Stop** and click on **Yes** for confirmation.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/298.png) 

### 15.1.5. Redeploy Azure Resources
1. Click on **Add** in existing resource group and re-deploy the ARM template. 

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/299.png) 
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/300.png) 

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/301.png)  

### 15.1.7. Start Stream analytics Job
1. Go to **Resource Group** and click on Secondary **Stream analytics job**.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/302.png)  

2. After click on stream analytics job, you will have directed to screen like below.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/303.png)  

**Note:** Before **Starting** the Stream analytic job, first you need to **Renew the authorization** of the **output DataLake**.
3. Click on **Datalake** in the output section it will navigate the output details page.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/304.png)  

4. Click on **Renew authorization** button and click *Save**.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/305.png)  

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/306.png)  

5. Start the Stream analytics job by click on **Start** and click on **Start** for confirmation.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/307.png)  
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/308.png)  

2. On **Overview** page click on **Edit**.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/309.png)  

3. Click on **“When a message is received in a queue (auto-complete)”.** And Click on **Change Connection**.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/310.png)  

4. Click on **“+ Add new connection”**

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/311.png)  


5. Enter **Connection Name** and choose Service bus name space which is in primary region. 

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/312.png)  

6. Choose **RootMangedSharedAccessKey** and click on **Create**.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/313.png)  
...
Login to the EdgeVm and restart the IoTEdge Service.
Run the below command to restart the IoTEdge service.
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/315.png)  

Now it will direct to **overview** page of the **dynocardVM**. 
2. **Copy** the **public IP address**.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/316.png)  

3. Open **Remote Desktop Connection** in your local computer and **past** the copied **dynocardVM** Public IP address.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/317.png)
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/318.png)  

5. Now Click **Yes** button to continue.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/319.png)  

6. It should open the **dynocardVM** and check the downloaded software.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/320.png)  

7. Run the v2 version of **ModRSsim2 simulator** by double clicking it.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/321.png)  
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/322.png)  

8. Click on **Animation setting** icon, which is located at right top menu bar.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/323.png)  

9. Select the **"Training PLC Simulation"** option and browse the **DynoCard.vb** script in downloaded section of the VM.
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/324.png)  
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/325.png)  
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/326.png)  

10. Select **Analog Inputs 300000**.
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/327.png)   
 
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/328.png)  
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/329.png)  
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/330.png)  

### 15.1.10.    Verify Triggers in Logic App in Secondary Region
1. Go to **Resource Group** and click on Secondary **logic app**.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/331.png)  

2. Scroll down to bottom of the page on **Overview** section to check logic app is running successfully or not. 

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/332.png)  
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/333.png)  

### 15.1.12.    Verify Data in Power BI
1. Open **Power BI Desktop** and click on Refresh to see updated graphs.
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/334.png)  
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/335.png)  

2. Login to the **Dynocard** VM with the credentials provided at ARM template deployment. Close running simulator.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/336.png)  

### 15.2.2. IoTHub Manual Failover
1. Go to **Resource Group** and Click on **IoTHub**.
 
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/337.png)  

2. Go to **Manual Failover (Preview)** from left side menu.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/338.png)  

3. Click on **Initiate failover** to initiate manual failover of IoTHub.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/339.png)  
...
1. Go to **Resource Group** and choose Primary SQL Server from list.
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/340.png)  

2. Click on **Failover groups** on left hand menu.
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/341.png)  


3. Click on **Failover Group**. 
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/342.png)  

4. A page will be displayed as below. Click on **Failover** and click on **Yes** for Confirmation.
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/343.png)  

A pop up will be displayed which shows progress of failover. Once failover is completed Primary Role and secondary role will interchange.

### 15.2.4. Stop Stream Analytics Job in Primary Region
1. Go to **Resource Group** and click on primary **Stream Analytics job**.
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/344.png)  

2. Stop the Stream analytics job by click on **Stop** and click on **Yes** for confirmation.
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/345.png)  

### 15.2.5. Start Stream analytics Job
1. Go to **Resource Group** and click on Secondary **Stream Analytics job**.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/346.png)  

2. After click on stream analytics job, you will have directed to screen like below.
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/347.png)  
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/348.png)  

4. Click on **Renew authorization** button and click **save**.
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/349.png)  
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/350.png)  
 
5. Start the Stream analytics job by click on **Start** and click on **Start** for confirmation.
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/351.png)  

### 15.2.6. Update Service Bus Endpoint in Logic App in Secondary Region
1. Go to **Resource Group** and click on secondary region **logic app**.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/352.png)   

2. On **Overview** page click on **Edit**.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/353.png)  

3. Click on **“When a message is received in a queue (auto-complete)”.** And Click on **Change Connection**.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/354.png)   

4. Click on **“+ Add new connection”**

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/355.png)   

5. Enter **Connection Name** and choose **Service Bus Namespace** which is in **Primary region**. 

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/356.png)  

6. Choose **RootMangedSharedAccessKey** and click on **Create.**
 
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/357.png)  
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/359.png)  

Now it will direct to **overview** page of the **dynocardVM**. 
2. **Copy** the **public IP address**.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/360.png)  

3. Open **Remote Desktop Connection** in your local computer and **past** the copied **dynocardVM** Public IP address.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/361.png)  
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/362.png)  

6. Now Click **Yes** button to continue.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/363.png)  

7, It should open the **dynocardVM** and check the downloaded software.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/364.png)  

8. Run the v2 version of **ModRSsim2 simulator** by double clicking it.
 
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/365.png)  

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/366.png)  

9. Click on **Animation setting** icon, which is located at right top menu bar.

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/367.png)  

10. Select the **"Training PLC Simulation"** option and browse the **DynoCard.vbs** script in downloaded section of the VM.
 
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/368.png)  

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/369.png)  

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/370.png)  
 
11. Select **Analog Inputs 300000.**

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/371.png)  
 
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/372.png)
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/373.png)  
...
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/374.png)  
 
### 15.2.8. Verify Triggers in Logic App in Secondary Region
1. Go to **Resource Group** and click on **Secondary logic app.**
 
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/375.png)  

2. Scroll down to bottom of the page on **Overview** section to check logic app is running successfully or not. 

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/376.png)  

### 15.2.9. Verify Data in SQL Database

1. Login to **SQL Database** using **SQL Management studio** and verify whether data is getting stored in database. 

![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/377.png)  

### 15.2.10.    Verify Data in Power BI
1. Open **Power BI Desktop** and click on Refresh to see updated graphs.
 
![alt text](https://github.com/BlueMetal/iot-edge-dynocard/blob/master/images/378.png)  
