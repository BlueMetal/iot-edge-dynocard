...
var AppComponent = /** @class */ (function () {
    function AppComponent() {
        this.title = 'iot-edge-dynocard-web';
    }
...
/* harmony import */ var _dynocard_dynocard_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./dynocard/dynocard.component */ "./src/app/dynocard/dynocard.component.ts");
/* harmony import */ var _modules_core_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../modules/core.module */ "./src/modules/core.module.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [
                ...
                _dynocard_dynocard_component__WEBPACK_IMPORTED_MODULE_2__["DynoCardComponent"]
            ],
            imports: [
                _modules_core_module__WEBPACK_IMPORTED_MODULE_3__["CoreModule"].forRoot()
            ],
            providers: [],
...
/***/ "./src/app/dynocard/dynocard.component.css":
/*!*************************************************!*\
  !*** ./src/app/dynocard/dynocard.component.css ***!
  \*************************************************/
/*! no static exports found */
...
/***/ "./src/app/dynocard/dynocard.component.html":
/*!**************************************************!*\
  !*** ./src/app/dynocard/dynocard.component.html ***!
  \**************************************************/
/*! no static exports found */
...
module.exports = "<h3>Graph: Dyno Card</h3>\n<h4 *ngIf=\"errorMessage\">\n  <div>Error: {{ errorMessage.message }}</div>\n  <div>Requested Url: {{ errorMessage.requestedUrl }}</div>\n</h4>\n<div *ngIf=\"!errorMessage\">\n  <div #controls></div>\n  <svg width=\"960\" height=\"800\"></svg>\n</div>\n"

/***/ }),

/***/ "./src/app/dynocard/dynocard.component.ts":
/*!************************************************!*\
  !*** ./src/app/dynocard/dynocard.component.ts ***!
  \************************************************/
/*! exports provided: DataColumns, DynoCardComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DataColumns", function() { return DataColumns; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DynoCardComponent", function() { return DynoCardComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var DynoCardComponent = /** @class */ (function () {
    function DynoCardComponent(dataService, urlManagingService) {
        this.dataService = dataService;
        this.urlManagingService = urlManagingService;
        this.eventSelVal = 'all';
        this.pumpSelVal = 'all';
        this.isDropDownRender = false;
        this.margin = { top: 150, right: 100, bottom: -100, left: 0 };
    ...
    DynoCardComponent.prototype.loadChartData = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.dataService.get(this.urlManagingService.getDynoCardData).toPromise()
                            .then(function (response) {
                            _this.chartData = response;
                            _this.controls.nativeElement.appendChild(_this.createInitialHeader());
                            var animateButton = _this.createAnimationButton();
    ...
    DynoCardComponent.prototype.renderChart = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        this.dynoCardSvg = d3__WEBPACK_IMPORTED_MODULE_2__["select"]("svg");
                    ...
                    case 1:
                        ...
                        this.dataSet.dataPoints.forEach(function (d) {
                            d.position = parseInt(d.position, 10);
                        });
                        xMax = d3__WEBPACK_IMPORTED_MODULE_2__["max"](this.dataSet.dataPoints, function (d) { return d.position; });
                        this.xAxis_Position = d3__WEBPACK_IMPORTED_MODULE_2__["scale"].linear().domain([-1, xMax]).range([0, this.svgCanvasWidth - 100]);
                        this.yAxis_Load = d3__WEBPACK_IMPORTED_MODULE_2__["scale"].linear().domain(d3__WEBPACK_IMPORTED_MODULE_2__["extent"](this.dataSet.dataPoints, function (d) { return d.load; })).range([this.svgCanvasHeight / 2, 0]);
                        xAxisLine = d3__WEBPACK_IMPORTED_MODULE_2__["svg"].axis().scale(this.xAxis_Position).orient("bottom").tickSize(5).tickFormat(function (d) { return d + ' in'; });
                        this.xAxisGroup.call(xAxisLine).attr({
                            transform: "translate(" + this.margin.right + ", " + (this.svgCanvasHeight - 20) + ")"
                        });
                        yAxisLine = d3__WEBPACK_IMPORTED_MODULE_2__["svg"].axis().scale(this.yAxis_Load).orient("left").tickSize(5).tickFormat(function (d) {
                            return Number(d) / 1000 + ' klb';
                        });
                        ...
                        this.drawLineFunc = d3__WEBPACK_IMPORTED_MODULE_2__["svg"].line().interpolate("basis")
                            .x(function (dp) {
    ...
    DynoCardComponent.prototype.animateGraph = function (argGraphDataSet) {
        var _this = this;
        var allDataPoints = lodash__WEBPACK_IMPORTED_MODULE_3__["sortBy"](argGraphDataSet, 'cardId');
        var surfaceDataGrp = lodash__WEBPACK_IMPORTED_MODULE_3__["groupBy"](lodash__WEBPACK_IMPORTED_MODULE_3__["filter"](allDataPoints, { 'cardType': 'S' }), 'cardHeaderId');
        var pumpCardDataGrp = lodash__WEBPACK_IMPORTED_MODULE_3__["groupBy"](lodash__WEBPACK_IMPORTED_MODULE_3__["filter"](allDataPoints, { 'cardType': 'P' }), 'cardHeaderId');
        var surCardDataArr = lodash__WEBPACK_IMPORTED_MODULE_3__["map"](surfaceDataGrp, surfaceDataGrp.value);
        var pumpCardDataArr = lodash__WEBPACK_IMPORTED_MODULE_3__["map"](pumpCardDataGrp, pumpCardDataGrp.value);
    ...
    DynoCardComponent.prototype.updateGraphData = function () {
        var retGraphDataSet = lodash__WEBPACK_IMPORTED_MODULE_3__["sortBy"](this.dataSet.dataPoints, 'cardId');
        if (this.pumpSelVal !== 'all')
            retGraphDataSet = lodash__WEBPACK_IMPORTED_MODULE_3__["filter"](this.dataSet.dataPoints, { 'pumpId': +this.pumpSelVal });
        ...
        if (!isNaN(startDateTime) && !isNaN(endDateTime)) {
            retGraphDataSet = lodash__WEBPACK_IMPORTED_MODULE_3__["filter"](this.dataSet.dataPoints, function (d) {
        ...
        if (this.eventSelVal !== 'all')
            retGraphDataSet = lodash__WEBPACK_IMPORTED_MODULE_3__["filter"](retGraphDataSet, { 'eventId': +this.eventSelVal });
    ...
    DynoCardComponent.prototype.getTableData = function () {
        ...
        return new Promise(function (resolve, reject) {
            ...
            var csvData = [];
            var retDataView;
            d3__WEBPACK_IMPORTED_MODULE_2__["csv"]("assets/dataset1.csv")
                ...
                retDataView = {
                    ...
                    maxValue: d3__WEBPACK_IMPORTED_MODULE_2__["max"](data, function (d) { return d.load; })
                };
    ...
    DynoCardComponent.prototype.renderCard = function (ci, surCardData, pumpCardData) {
        ...
        this.plotteSurfacedPath = d3__WEBPACK_IMPORTED_MODULE_2__["select"](document.getElementById("surfaceCard")).selectAll("path");
        ...
        plotPumpPath.attr("stroke", "brown")
            ...
            .attr("fill", "none")
            .attr("d", this.drawLineFunc);
        this.plottePumpPath = d3__WEBPACK_IMPORTED_MODULE_2__["select"](document.getElementById("pumpCard")).selectAll("path");
    ...
    DynoCardComponent.prototype.rerenderEventDropDown = function () {
        ...
        var tmpEventDDList = lodash__WEBPACK_IMPORTED_MODULE_3__["uniq"](lodash__WEBPACK_IMPORTED_MODULE_3__["map"](updatedDataSet, 'eventId'));
    ...
    DynoCardComponent.prototype.createDropDown = function (argDropDownType) {
        ...
        if (argDropDownType === DataColumns.pumpId) {
            ...
            var pumpIdList = lodash__WEBPACK_IMPORTED_MODULE_3__["uniq"](lodash__WEBPACK_IMPORTED_MODULE_3__["map"](this.dataSet.dataPoints, 'pumpId'));
            dropDownData = lodash__WEBPACK_IMPORTED_MODULE_3__["map"](pumpIdList, function (item) { return String(item); });
        }
        else if (argDropDownType === DataColumns.cardType) {
            labelDiv.appendChild(document.createTextNode("Card Type"));
            dropDownData = lodash__WEBPACK_IMPORTED_MODULE_3__["uniq"](lodash__WEBPACK_IMPORTED_MODULE_3__["map"](this.dataSet.dataPoints, 'cardType'));
            ...
            dropDownData = lodash__WEBPACK_IMPORTED_MODULE_3__["uniq"](lodash__WEBPACK_IMPORTED_MODULE_3__["map"](this.dataSet.dataPoints, 'eventId'));
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('controls'),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], DynoCardComponent.prototype, "controls", void 0);
    DynoCardComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'dynocard-chart',
            template: __webpack_require__(/*! ./dynocard.component.html */ "./src/app/dynocard/dynocard.component.html"),
            styles: [__webpack_require__(/*! ./dynocard.component.css */ "./src/app/dynocard/dynocard.component.css")],
            encapsulation: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewEncapsulation"].None
        }),
        __metadata("design:paramtypes", [_services__WEBPACK_IMPORTED_MODULE_1__["DataService"], _services__WEBPACK_IMPORTED_MODULE_1__["UrlManagingService"]])
    ], DynoCardComponent);
 ...
 * DEBUGGING
 */
_services__WEBPACK_IMPORTED_MODULE_4__["LogService"].DEBUG.LEVEL_4 = !_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].production;
var BASE_PROVIDERS = _services__WEBPACK_IMPORTED_MODULE_4__["CORE_PROVIDERS"].concat([
    {
...
var CoreModule = /** @class */ (function () {
    function CoreModule(parentModule) {
        Object(_utils_index__WEBPACK_IMPORTED_MODULE_2__["throwIfAlreadyLoaded"])(parentModule, 'CoreModule');
    }
    ...
    CoreModule.forRoot = function (configuredProviders) {
        return {
            ...
            providers: BASE_PROVIDERS.slice()
        };
    };
    var CoreModule_1;
    ...
    DataService.prototype.get = function (url, requestOptionsArgs, options) {
        ...
        if (options) {
            if (!options.mockData) {
                ...
                return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(mockData);
            }
...
/*!*******************************!*\
  !*** ./src/services/index.ts ***!
  \*******************************/
/*! exports provided: CORE_PROVIDERS, DataService, LogService, UrlManagingService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CORE_PROVIDERS", function() { return CORE_PROVIDERS; });
/* harmony import */ var _log_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./log.service */ "./src/services/log.service.ts");
/* harmony import */ var _data_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./data.service */ "./src/services/data.service.ts");
/* harmony import */ var _url_managing_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./url-managing.service */ "./src/services/url-managing.service.ts");
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "UrlManagingService", function() { return _url_managing_service__WEBPACK_IMPORTED_MODULE_2__["UrlManagingService"]; });




var CORE_PROVIDERS = [_log_service__WEBPACK_IMPORTED_MODULE_0__["LogService"], _data_service__WEBPACK_IMPORTED_MODULE_1__["DataService"],
    _url_managing_service__WEBPACK_IMPORTED_MODULE_2__["UrlManagingService"]];
...
/***/ "./src/services/url-managing.service.ts":
/*!**********************************************!*\
  !*** ./src/services/url-managing.service.ts ***!
  \**********************************************/
/*! exports provided: UrlManagingService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UrlManagingService", function() { return UrlManagingService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var prodUrl = 'http://localhost:8201';
...
var UrlManagingService = /** @class */ (function () {
    function UrlManagingService() {
        ...
        this.getDynoCardData = this.baseApiRoute + '/DynoCard';
    }
...
/*!****************************!*\
  !*** ./src/utils/index.ts ***!
  \****************************/
/*! exports provided: throwIfAlreadyLoaded, isString, isObject */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _angular__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./angular */ "./src/utils/angular.ts");
...
/* harmony import */ var _objects__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./objects */ "./src/utils/objects.ts");
...
module.exports = __webpack_require__(/*! C:\Source\BlueMetal\iot-edge-dynocard\code\dynocard_alert\modules\dynocard_web\dynocardweb\src\main.ts */"./src/main.ts");
